...
const SHOTS = [
  ['01-reception', 0, 4.05, 0, 1.5],
  ['02-passage-mid', 0, -5.5, 0, 2],
  ['03-passage-exit', 0, -12.6, 0, 6],
  ['04-around-reveal', -3.3, -14.5, 25, 4],
  ['05-court-product-wall', 0.9, -15.9, 350, 3],
  ['06-gallery-a-from-north', -2.9, -13.2, 180, 0],
  ['07-hero-01', -2.3, -3.4, 270, 2],
  ['08-gallery-b', 2.9, -13.3, 180, 0],
  ['09-look-up-skylight', 0, -8, 0, 50],
  ['10-gallery-c', 2.6, -1.0, 350, 2],
  ['11-hero-05-table', 3.4, -8.9, 290, -14],
  ['12-reveal-wall-close', 0, -13.9, 0, 12],
  ['20-atrium-arrival', 0, 16.4, 0, 6],
  ['21-atrium-look-back', 0, 6.4, 180, 8],
  ['22-atrium-roof', 0, 11, 0, 55],
  ['23-theatre', -11.2, 11.3, 270, 4],
  ['24-workshop', 11.6, 16.6, 25, -2],
  ['25-workshop-north', 17.6, 14.5, 0, -4],
  ['26-courtyard', 17.6, -7.0, 0, 2],
  ['27-courtyard-back', 17.6, -17.4, 180, 6],
]
